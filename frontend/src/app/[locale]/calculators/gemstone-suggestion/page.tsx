...
import GemstoneSuggestionClient from "./GemstoneSuggestionClient";

const TOOL = CALCULATOR_TOOLS.find((t) => t.id === "gemstone-suggestion")!;
...
export default async function Page({
  ...
  return (
    <>
      ...
      />
      <GemstoneSuggestionClient locale={locale} />
    </>
  );
}
