...
import RudrakshaMappingClient from "./RudrakshaMappingClient";

const TOOL = CALCULATOR_TOOLS.find((t) => t.id === "rudraksha-mapping")!;
...
export default async function Page({
  ...
  return (
    <>
      ...
      />
      <RudrakshaMappingClient locale={locale} />
    </>
  );
}
