...
import PlanetaryPositionsClient from "./PlanetaryPositionsClient";

const TOOL = CALCULATOR_TOOLS.find((t) => t.id === "planetary-positions")!;
...
export default async function Page({
  ...
  return (
    <>
      ...
      />
      <PlanetaryPositionsClient locale={locale} />
    </>
  );
}
