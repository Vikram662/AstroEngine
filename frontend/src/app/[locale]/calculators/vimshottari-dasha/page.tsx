...
import VimshottariDashaClient from "./VimshottariDashaClient";

const TOOL = CALCULATOR_TOOLS.find((t) => t.id === "vimshottari-dasha")!;
...
export default async function Page({
  ...
  return (
    <>
      ...
      />
      <VimshottariDashaClient locale={locale} />
    </>
  );
}
