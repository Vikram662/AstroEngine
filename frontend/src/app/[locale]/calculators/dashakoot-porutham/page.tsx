...
import DashakootPoruthamClient from "./DashakootPoruthamClient";

const TOOL = CALCULATOR_TOOLS.find((t) => t.id === "dashakoot-porutham")!;
...
export default async function Page({
  ...
  return (
    <>
      ...
      />
      <DashakootPoruthamClient locale={locale} />
    </>
  );
}
